...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_model', type=str, default = './model_exp/2021-01-08_10-30-02/model_epoch-1.pth',
    ...
    parser.add_argument('--GPUS', type=str, default = '0',
        help = 'GPUS') # GPU选择
    parser.add_argument('--test_path', type=str, default = 'H:/git_project/dpsu/multi_face/',
